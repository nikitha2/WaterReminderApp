...
import com.example.android.background.sync.BroadcastReceiver;
import com.example.android.background.sync.ReminderTasks;
import com.example.android.background.sync.WaterReminderIntentService;
import com.example.android.background.sync.WaterReminderService;
import com.example.android.background.utilities.PreferenceUtilities;
import com.example.android.background.utilities.ReminderUtils;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Dynamic broadcastReceiver- will be active only till the lifecycle of the activity
       ...
       /* sticky intent to check the battery status on opening app:
        A sticky intent is a broadcast intent that sticks around, allowing your app to access it at any point and get information from the 
        broadcasted intent. In Android, a sticky intent is where the current battery state is saved.
        */
    ...
    public void incrementWater(View view) {
        ...
        Intent intent1 = new Intent(this, WaterReminderService.class);

        intent1.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
